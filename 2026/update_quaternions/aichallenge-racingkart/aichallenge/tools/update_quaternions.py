...
# スクリプトがmemo/に置かれた場合、../workspace/src/aichallenge_submit/simple_trajectory_generator/data を参照する
_SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
_DATA_DIR = os.path.normpath(os.path.join(_SCRIPT_DIR, '..', 'workspace', 'src', 'aichallenge_submit', 'simple_trajectory_generator', 'data'))


def _resolve_path(path):
    """相対パスをCWD→スクリプト相対のdataディレクトリの順で解決する"""
...
def main():
    ...
    output_path = _resolve_path(args.output) if args.output else input_path
